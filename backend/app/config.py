...
class Config:
    ...
    SQLALCHEMY_DATABASE_URI = os.environ.get('DATABASE_URL', 'postgresql://user:pass@localhost:5432/fruiq')
    SQLALCHEMY_TRACK_MODIFICATIONS = False
    REDIS_URL = os.environ.get('REDIS_URL', 'redis://localhost:6379/0')
    MODEL_PATH = os.environ.get('MODEL_PATH', './models/trained/efficientnet_v2.h5')
